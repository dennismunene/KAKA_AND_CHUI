...
public class ZoeziTarakimuScene extends ParentScene implements OnClickListener {

	private ZoeziTarakimuModel model;
	...
	public ZoeziTarakimuScene(BaseGameActivity act, Engine eng, Camera cam) {
		this.activity = act;
		this.engine = eng;
		this.mCamera = cam;
		
		model = new ZoeziTarakimuModel(activity, engine, mCamera);
	...
	private void setZoeziItems() {
		...
		sprite1.setPosition(-65, -140);
		sprite2.setPosition(-65, mCamera.getHeight() - sprite2.getHeight()
				+ 145);
		sprite3.setPosition(mCamera.getWidth() - sprite3.getWidth() + 145, -140);
		sprite4.setPosition(mCamera.getWidth() - sprite4.getWidth() + 145,
