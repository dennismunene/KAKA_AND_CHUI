...
import com.game254studios.view.ZoeziRangiView;


public class ZoeziRangiModel extends Model {

	private BaseGameActivity activity;
	private Engine engine;
	private Camera mCamera;
	private ZoeziRangiView view;

	public ZoeziRangiModel(BaseGameActivity act, Engine eng, Camera cam) {
		this.activity = act;
		this.engine = eng;
		this.mCamera = cam;

		view = new ZoeziRangiView(act, eng, cam);
	}
