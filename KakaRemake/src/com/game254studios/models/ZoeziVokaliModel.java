...
import com.game254studios.view.ZoeziVokaliView;

public class ZoeziVokaliModel extends Model {

	private BaseGameActivity activity;
	private Engine engine;
	private Camera mCamera;
	private ZoeziVokaliView view;

	public ZoeziVokaliModel(BaseGameActivity act, Engine eng, Camera cam) {
		this.activity = act;
		this.engine = eng;
		this.mCamera = cam;

		view = new ZoeziVokaliView(act, eng, cam);
	}
