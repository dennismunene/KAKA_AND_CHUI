...
import com.game254studios.view.SomaMaumboView;
...
public class SomaMaumboModel extends Model{

	private BaseGameActivity activity;
	private Engine engine;
	private Camera mCamera;
	private SomaMaumboView  view;
	
	public SomaMaumboModel(BaseGameActivity act,Engine eng,Camera cam) {
		this.activity=act;
		this.engine =eng;
		this.mCamera = cam;
		
		view = new SomaMaumboView(act, eng, cam);
	}
