...
public class ZoeziVokaliView extends MyView {
	...
	private ITextureRegion bgTR, aTR, eTR, iTR, oTR, uTR, greenTickTR, redXTR,
			backTR, nextTR, prevTR;
	...
	private Sound buttonSound,clapping;

	public ZoeziVokaliView(BaseGameActivity act, Engine eng, Camera cam) {
